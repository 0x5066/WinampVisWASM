...
#else
				pthread_mutex_init(&cerr_cs, nullptr);
				pthread_mutex_init(&map_cs, nullptr);
...
#else
				pthread_mutex_destroy(&cerr_cs);
				pthread_mutex_destroy(&map_cs);
...
#else
			pthread_mutex_t cerr_cs, map_cs;
#endif
